...
const PLATFORMS = [
  {
    ...
    icon: '\uF8FF',
    app: 'Hiddify',
    appUrl: 'https://apps.apple.com/us/app/hiddify-proxy-vpn/id6596777532',
    steps: [
      'Скачайте приложение Hiddify из App Store.',
  ...
  },
  {
    ...
    steps: [
      'Скачайте Hiddify (ссылка выше). Установите файл .msix для Windows.',
  ...
  },
  {
    ...
    appUrl: 'https://github.com/hiddify/hiddify-app/releases/latest',
    steps: [
      'Скачайте Hiddify (ссылка выше). Откройте DMG и перетащите в Applications.',
  ...
  },
  {
    ...
    appUrl: 'https://github.com/hiddify/hiddify-app/releases/latest',
    steps: [
      'Скачайте Hiddify (ссылка выше).',
      'Сделайте файл исполняемым: chmod +x Hiddify-Linux.AppImage',
      'Запустите: ./Hiddify-Linux.AppImage',
      'Запустите приложение и нажмите "Новый профиль".',
